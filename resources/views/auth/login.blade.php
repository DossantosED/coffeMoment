@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Coffee Moment')])
          ...
          <div class="card-body">
            ...
            <div class="bmd-form-group{{ $errors->has('password') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="password" name="password" id="password" class="form-control" placeholder="{{ __('Contraseña') }}" value="{{ !$errors->has('password') ? "" : "" }}" required autocomplete="password">
              </div>
